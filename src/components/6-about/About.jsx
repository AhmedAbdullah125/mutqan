...
const About = () => {
  ...
  return (
    <section 
      ...
      ref={ref} 
      className={`
        py-16 font-cairo relative overflow-hidden
      ...
      >
        <div className="text-center mb-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="h-1 bg-gradient-to-r from-emerald-500 to-emerald-500 mx-auto rounded-full"
          />
        </div>
              ...
              return (
                <motion.div
                  ...
                  className={`
                    ...
                    ${index >= stats.length - 2 ? "col-span-2 md:col-span-1" : ""}
